...
export default function UserDashboardLayout({ children }) {
  ...
  const screenHeight = 'calc(100vh - 6rem)';
  ...
  return (
    <>
      ...
      >
        ...
        {/* Main Content */}
        <main className="w-full" style={{ height: screenHeight }}>
          <div className="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none h-full">
            {children}
          </div>
        </main>
      </div>
